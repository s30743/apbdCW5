...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var deptsCHicago = depts.Where(d => d.Loc == "CHICAGO").Select(d => d.DeptNo).ToList();
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(c => new
        {
            DeptNo = c.Key, Count = c.Count()
        });
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        {
            DeptNo = g.Key, AvgSal = g.Average(e => e.Sal)
        }); 
        //
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        var emps = Database.GetEmps();
         ...
         var result = emps.Where(e => e.Sal > emps.Where(g => g.DeptNo == e.DeptNo).Average(e => e.Sal)).Select(e => e.EName); 
        //
